  ...
  describe :find_all_with_email_domain do
    context 'given a domain name' do
      before do
        ...
        @john = Person.create({ first_name: 'John', last_name: 'Doe', email: 'john.doe@gmail.com' })
        @jane = Person.create({ first_name: 'Jane', last_name: 'Doe', email: 'jane.doe@yahoo.com' })
        @mary = Person.create({ first_name: 'Mary', last_name: 'Jane', email: 'mary.jane@gmail.com' })
      end
    ...
    context 'given no domain name' do
